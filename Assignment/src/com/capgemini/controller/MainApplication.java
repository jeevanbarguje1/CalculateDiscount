...
public class MainApplication {
	...
	public static void main(String[] args) {
		 ...
		 * System.out.print("Please enter the User name: " + sc.nextLine());
		 ...
		 * 
		 * int productCount = sc.nextInt(); List<Product> list = new
		 * ArrayList<>(); Product A[]=new Product[productCount];
		 * 
		 * for (int i = 0; i < productCount; i++) {
		 * System.out.println("enter the product name: "); String productName =
		 * sc.nextLine();
		 * System.out.println("enter the product type 1-->GROCERIES" +
		 * "2-->NONGROCERIES"); int input = sc.nextInt(); ProductType
		 * productType = (input == 1) ? (ProductType) ProductType.GROCERIES :
		 * ProductType.NONGROCERIES;
		 * System.out.println("enter the product price: "); double productPrice
		 * = sc.nextDouble();
		 * 
